...
public class PlayerNameView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 20, -1, 90));

        playerName.setFont(new java.awt.Font("Agency FB", 1, 48)); // NOI18N
        jPanel1.add(playerName, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 170, 650, 70));
        ...
        jPanel1.add(btnExitGame, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 280, 310, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlayerNameView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlayerNameView().setVisible(true);
            }
        });
    }
