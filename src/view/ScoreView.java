...
public class ScoreView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 10, -1, 90));
        ...
        scoreTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Player name", "Score", "Date time"
            }
        ));
        jScrollPane1.setViewportView(scoreTable);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 800, 410));

        btnReturnMainMenu.setBorder(null);
        btnReturnMainMenu.setBorderPainted(false);
        btnReturnMainMenu.setContentAreaFilled(false);
        jPanel1.add(btnReturnMainMenu, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 550, 152, 70));
